...
import { Search, MapPin, User, Heart, ShoppingCart, Menu, X, ChevronDown, LogIn, UserPlus } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center gap-4 relative">
              ...
              <div className="relative hidden md:block">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${isCityDropdownOpen ? 'transform rotate-180' : ''}`} />
                </Button>
              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="hidden md:inline text-sm font-medium">{user.name || 'حسابي'}</span>
                    <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform duration-200 ${isUserMenuOpen ? 'transform rotate-180' : ''}`} />
                  </Button>
                  {isUserMenuOpen && (
                ...
                >
                  ...
                  <span className="hidden md:inline text-sm font-medium">تسجيل دخول</span>
                </Button>
              )}
              ...
              >
                <Link to="/cart" className="flex items-center">
                  ...
                  <span className={`absolute -top-1 -right-1 bg-green-500 text-white text-xs font-medium rounded-full w-5 h-5 flex items-center justify-center shadow-sm transition-all ${cartItemsCount > 0 ? 'scale-100' : 'scale-0'}`}>
          ...
          <div className="hidden md:flex items-center justify-center py-3 border-t border-gray-100 bg-white">
            <div className="flex items-center gap-6 text-sm font-medium">
              ...
              {['trending', 'perfumes', 'medicines', 'cosmetics', 'baby', 'medical'].map((category) => {
                const categoryNames = {
