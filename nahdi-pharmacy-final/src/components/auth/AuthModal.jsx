  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Call the success handlers if provided
        if (onLoginSuccess) {
          onLoginSuccess();
        ...
        // Force a re-render of the entire app to ensure all components get the updated auth state
        ...
        const redirectPath =
          location.state?.from?.pathname || searchParams.get("redirect") || "/";
      ...
      const errorMessage =
        err.message || "بيانات الدخول غير صحيحة. يرجى المحاولة مرة أخرى.";
