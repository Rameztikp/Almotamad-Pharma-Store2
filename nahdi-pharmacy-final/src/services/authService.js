...
const authService = {
  ...
  // الحصول على ملف المستخدم - محسّن لمنع الحلقات اللانهائية
  getProfile: async function () {
    try {
      console.log("🔍 محاولة جلب بيانات المستخدم...");

      // لا نفحص الكوكيز مسبقاً - نعتمد على /auth/me مباشرة
      // هذا يمنع مشاكل التزامن مع HttpOnly cookies عبر النطاقات المختلفة
